...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
    ...
    def mostRetweeted: Tweet = {
      lazy val leftMostRetweeted = if (!left.isEmpty()) left.mostRetweeted else null
      lazy val rightMostRetweeted = if (!right.isEmpty()) right.mostRetweeted else null
